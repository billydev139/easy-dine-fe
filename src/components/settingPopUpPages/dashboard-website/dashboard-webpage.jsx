...
alert(
  `Form submitted with Phone: ${formData.phoneNumber}, Email: ${formData.email}`
);
          ...
          <div className="bg-white dark:bg-[#222630] transition-all rounded-[10px] shadow-md px-[51px] py-4">
            ...
            <div className="flex gap-x-32 mb-5">
              ...
              <div className="">
                ...
                <p className="text-xs text-[#696969] dark:text-white mt-1">
                  The site icon is what you see in browser tabs etc. It should
                  be square and at least{" "}
                  <span className="font-medium">512 x 512</span> pixels.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-x-[109px] mb-4">
              ...
              <div className="">
                <div className="flex items-center">
                  ...
                  <div>
                    {faviconImage ? (
                      ...
                      <img
                        src="../src/assets/images/A-icon.png"
                        alt="favicon"
                      />
                    )}
                  </div>
                ...
                <p className="text-xs text-[#696969] dark:text-white mt-1">
                  The site icon is what you see in browser tabs etc. It should
                  be square and at least 512 x 512 pixels.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-x-2.5">
              ...
              <div className="relative" ref={hourStartRef}>
                <button
                  ...
                  onClick={() =>
                    setShowHourStartDropdown(!showHourStartDropdown)
                  }
                >
                  ...
                  >
                    {preview ? (
                      ...
                      <div className="text-center">
                        ...
                        {file && (
                          <p className="text-xs text-[#0075FF] mt-1">
                            {file.name}
                          </p>
                        )}
                      </div>
