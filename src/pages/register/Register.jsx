...
import { FaRegUser, FaRegEye, FaRegEyeSlash, FaCheckCircle } from 'react-icons/fa';
...
import OrRegisterWith from '../../components/or-register-with';
        ...
        <div className='max-w-md w-full p-6 bg-white rounded-lg shadow-lg'>
          <div className='text-center'>
            ...
            <p className='text-gray-600 mb-4'>
              Your account has been successfully created. Click below to continue to your
              dashboard.
            </p>
            <button
      ...
      <div className='flex flex-col items-start justify-center bg-gradient-to-b from-white via-white to-white'>
        <div className='mx-auto max-sm:mx-4 w-full max-w-md'>
          ...
          <p className='text-[#585858] font-medium mb-8 md:text-[16px] text-[14px] text-center mt-3'>
            {activeStep === 1
              ? 'Enter your business details and select a package'
          ...
          <div className='flex justify-center gap-x-1'>
            ...
            <Link
              to='/auth/signup'
              className='text-base font-outfit font-medium text-[#1967D2] hover:underline whitespace-nowrap'
            >
              Log in
            </Link>
          </div>
