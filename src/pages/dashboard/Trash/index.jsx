...
import TrashInvoices from './trash-invoices';
import TrashOrders from './trash-orders';
import TrashStaff from './trash-staff';
...
export default function Trash() {
  ...
  // Tab data
  const tabs = ['All', 'Items', 'Invoices', 'Orders', 'Staff'];
  ...
  const tabData = {
    Items: [
      { id: 1, name: 'Coffee', category: 'Beverages', price: '$2.50', stock: 120 },
      { id: 2, name: 'Tea', category: 'Beverages', price: '$1.99', stock: 85 },
      { id: 3, name: 'Sandwich', category: 'Food', price: '$5.99', stock: 42 },
    ],
    Invoices: [
      {
        id: 'INV-001',
  ...
  // Tab icon mapping
  const tabIcons = {
    Items: <Utensils className='w-5 h-5 mr-2' />,
    Invoices: <FileText className='w-5 h-5 mr-2' />,
    Orders: <ShoppingCart className='w-5 h-5 mr-2' />,
    Staff: <Users className='w-5 h-5 mr-2' />,
  };
          ...
          <>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-5'>
              {stats.map((stat, index) => (
                ...
                >
                  <div>
                    <p className='text-sm font-medium text-[#1A2042] mb-1'>
                      {stat.title}
                    </p>
                    <h3 className='text-xl text-[#1A2042] font-bold mb-1.5'>
                      {stat.value}
                    </h3>
                          ...
                          <tr key={item.id} className='border-b border-[#E1E1E1]'>
                            <td className='px-4 py-4 text-sm'>
                              <div className='flex items-center'>
                                <Utensils className='w-4 h-4 text-[#0075FF] mr-2' />
                                {item.category}
                              </div>
                            </td>
  ...
  return (
    <DashboardLayout>
      <div className='my-4'>
        <nav className='flex'>
          {tabs.map(tab => (
            <button
              key={tab}
              className={`pb-2 pt-6 px-6 text-lg font-semibold ${
                activeTab === tab
                  ? 'border-b-2 border-[#00925C] text-[#00925C]'
                  : 'text-[#717B8C] hover:text-gray-700 hover:border-gray-300'
              }`}
      ...
      <div className='mb-6 min-h-screen py-4'>
