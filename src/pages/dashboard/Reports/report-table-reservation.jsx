...
import { TrendingUp, ClipboardCheck, UsersRound } from 'lucide-react';
import { TfiWallet } from 'react-icons/tfi';

const ReportTableReservation = () => {
          ...
          {[
            ...
            >
              <div>
                ...
                <p className='text-2xl text-[#1A2042] font-bold mb-2.5'>{metric.value}</p>
...
export default ReportTableReservation;
